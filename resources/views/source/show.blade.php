                                    ...
                                    <div class="flex py-2">
                                        <div>
                                            <div class="flex-shrink-0 h-10 w-10 mb-2">
                                                <img class="h-10 w-10 rounded-full" src="{{ strpos($story->user()->first()->file_name,'avatar') == false ? 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80' : asset($story->user()->first()->file_name) }}" alt="">
                                            </div>    
