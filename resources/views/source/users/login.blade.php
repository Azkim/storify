    ...
    <div class="flex justify-center items-center h-screen bg-gray-200 px-6">
        <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
            <div class="flex justify-center items-center">
                ...
                <span class="text-gray-700 font-semibold text-2xl">Storify</span>
            </div>
            ...
            <form class="mt-4" method="POST" action="{{ route('login') }}">
                ...
                <label class="block">
                    <span class="text-gray-700 text-sm" :value="__('Email')">Email</span>
                    <input type="email" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600" :value="old('email')" name="email" required autofocus>
                </label>

                <label class="block mt-3">
                    <span class="text-gray-700 text-sm" :value="__('Password')">Password</span>
                    <input type="password" class="form-input mt-1 block w-full rounded-md focus:border-indigo-600" name="password" required autocomplete="current-password">
                </label>
                ...
                <div class="flex justify-between items-center mt-4">
                    ...
                    <div>
                        ...
                        <a class="block text-sm fontme text-indigo-700 hover:underline" href="{{ route('password.request') }}">Forgot your password?</a>
                        @endif
                    </div>
                </div>
