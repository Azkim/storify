            ...
            <table class="min-w-full border-collapse block md:table">
                <thead class="block md:table-header-group">
                    <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative xs:invisible sm:invisible md:visible lg:visible xl:visible">
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">USER ID</th>
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">USER DETAILS</th>
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">DATE CREATED</th>
                        <th class="grid place-items-center bg-gray-600 py-2 pl-4 pr-8 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">STORIES</th>
                        <th class="bg-gray-600 py-2 pl-4  text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">ACTION</th>
                    </tr>
                </thead>
                <tbody class="block md:table-row-group">
                    @foreach($results as $result)
                    <tr class="bg-gray-100 border border-grey-500 md:border-none block md:table-row">
                        <td class="line-clamp-3 md:break-all text-clip py-2 pl-4 md:border md:border-grey-500 text-left block md:table-cell"><span class="line-clamp-2 text-clip inline-block w-full md:hidden font-bold">USER ID</span>{{ $result->id }}</td>
                        ...
                        <td class="md:break-all text-clip py-2 pl-4 md:border md:border-grey-500 text-left block md:table-cell"><span class="text-clip inline-block w-full md:hidden font-bold">CREATED AT</span>{{\Carbon\Carbon::parse($result->created_at)->format('Y-m-d H:i', '2016-11-05 12:00')}}</td>
                        <td class=" md:break-all text-clip py-2 pl-4 md:border md:border-grey-500 text-left block md:table-cell"><span class="text-clip inline-block w-full md:hidden font-bold">STORIES</span>
