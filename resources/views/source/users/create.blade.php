...
@section('body')
<container>
  <div class="mt-10 sm:mt-14 border-solid border-1 border-indigo-300 sm:rounded-md" style="padding:20px 20px 20px 30px"
>
    <div class="md:grid md:grid-cols-3 md:gap-6">
      <div class="md:col-span-1">
        <div class="px-4 sm:px-6">
          ...
          <p class="mt-1 text-sm text-gray-600">Create a user and give them a description</p>
        </div>
      </div>
            ...
            <div class="px-4 py-5 bg-white sm:p-6 sm:rounded-md">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 xl:col-span-3">
                  ...
                  <input type="text" name="name" value="{{ old('name') }}" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('name') is-invalid border-red-500 @enderror">
                  @error('name')
                ...
                <div class="col-span-6 xl:col-span-3">
                  ...
                  <input type="email" name="email" value="{{ old('email') }}" autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('email') is-invalid border-red-500 @enderror">
                  @error('email')
                    <div class="alert alert-danger flex items-center font-medium tracking-wide text-red-500 text-sm mt-1 ml-1">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-span-6 xl:col-span-3">
                  ...
                  <input type="password" name="password" value="{{ old('password') }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('password') is-invalid border-red-500 @enderror" autocomplete="current-password @error('password') is-invalid border-red-500 @enderror">
                  @error('password')
                    <div class="alert alert-danger flex items-center font-medium tracking-wide text-red-500 text-sm mt-1 ml-1">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="col-span-6">
                  ...
                  <div class="mt-1">
                    <textarea value="{{ old('description') }}" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md @error('description') is-invalid border-red-500 @enderror" placeholder="About you..."></textarea>
                  </div>
