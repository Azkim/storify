<header class="flex justify-between items-center pl-4 py-4 pr-4 bg-white border-b-4 border-indigo-600">
    ...
    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="hidden md:block">
            <button @click="notificationOpen = ! notificationOpen" class="flex mr-3 text-gray-600 focus:outline-none">
                <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            <button @click="dropdownOpen = ! dropdownOpen" class="relative block h-8 w-8 rounded-full overflow-hidden shadow focus:outline-none">
                <img class="object-scale-down" src="{{ asset(auth()->user()->file_name) }}" alt="Your avatar">
            </button>
