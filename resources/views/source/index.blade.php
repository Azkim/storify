            ...
            <table class="min-w-full border-collapse block md:table">
                <thead class="block md:table-header-group">
                    <tr class="border border-grey-500 md:border-none block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative xs:invisible sm:invisible md:visible lg:visible xl:visible">
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">TIME CREATED</th>
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">AUTHOR</th>
                        <th class="bg-gray-600 py-2 pl-4 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">TITLE OF STORY</th>
                        <th class="grid place-items-center bg-gray-600 py-2 pl-4 pr-8 text-white text-sm font-bold md:border md:border-grey-500 text-left block md:table-cell">STATUS</th>
                ...
                <tbody class="block md:table-row-group">
                    ...
                    <tr class="bg-gray-100 border border-grey-500 md:border-none block md:table-row">
                        ...
                        <td class="py-2 pl-4 md:border md:border-grey-500 text-left block md:table-cell"><span class="mb-1000 inline-block w-full md:hidden font-bold">Author</span>{{ $result->name }}</td>
