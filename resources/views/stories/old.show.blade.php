              ...
              <div class="flex justify-between items-center mt-4">
                    ...
                    <div class="flex items-center justify-center">
                        <div class="inline-flex shadow-md hover:shadow-lg focus:shadow-lg" role="group">
                            <a href="{{ url()->previous() }}">
                                <button type="button" class="rounded-l px-6 py-1.5 bg-blue-600 text-white font-bold text-xs leading-tight uppercase hover:bg-blue-700 focus:bg-blue-700 focus:outline-none focus:ring-0 active:bg-blue-800 transition duration-150 ease-in-out">
                            ...
                            <a href="{{ route('stories.edit',[$story]) }}">
                                <button type="button" class="rounded-r px-6 py-1.5 bg-green-600 text-white font-bold text-xs leading-tight uppercase hover:bg-green-700 focus:bg-green-700 focus:outline-none focus:ring-0 active:bg-green-800 transition duration-150 ease-in-out">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
